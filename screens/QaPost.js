      ...
      <Block>
        ...
        <Block style={styles.navbar}>
          <NavBar
            transparent
            // left={(
            // <TouchableHighlight style={{top: 50 }}  >
            //     <Button
        ...
        <Block center style={{ marginTop: -theme.SIZES.BASE * 2 }}>
          <Block flex style={styles.header}>
            ...
            <Text style={styles.text}>
              ...
              created by developers for developers. You should totally like
              check this out, ok? Why would you use another UI library when you
              have so many components written by Creative Tim and the whole
              React Native community. Galio was created by developers for
              developers.
            </Text>
            <Text style={styles.text}>
